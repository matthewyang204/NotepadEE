...
# build directory.
ITK_BUILD_LIB_SPEC='-L/private/tmp/tcl-tk--itk4-20241221-6502-937xo6/itk-itk-4-2-3 -litk4.2.3'

# String to pass to linker to pick up the Itk library from its
# installed directory.
ITK_LIB_SPEC='-L/usr/local/Cellar/tcl-tk/9.0.1/lib/itk4.2.3 -litk4.2.3'
...
# build directory.
ITK_BUILD_STUB_LIB_SPEC='-L/private/tmp/tcl-tk--itk4-20241221-6502-937xo6/itk-itk-4-2-3 -litkstub4.2.3'

# String to pass to linker to pick up the Itk stub library from its
# installed directory.
ITK_STUB_LIB_SPEC='-L/usr/local/Cellar/tcl-tk/9.0.1/lib/itk4.2.3 -litkstub4.2.3'
...
ITK_SRC_DIR='/private/tmp/tcl-tk--itk4-20241221-6502-937xo6/itk-itk-4-2-3'
