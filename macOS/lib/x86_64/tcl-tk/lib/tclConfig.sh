...
# installed.
TCL_PREFIX='/usr/local/Cellar/tcl-tk/9.0.1'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/local/Cellar/tcl-tk/9.0.1'
...
TCL_EXTRA_CFLAGS='-pipe  -arch x86_64 -finput-charset=UTF-8  '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/private/tmp/tcl-tk-20241221-6502-car2ia/tcl9.0.1/unix -ltcl9.0'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/local/Cellar/tcl-tk/9.0.1/lib -ltcl9.0'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/local/Cellar/tcl-tk/9.0.1/include/tcl-tk'
...
# compiled.
TCL_SRC_DIR='/private/tmp/tcl-tk-20241221-6502-car2ia/tcl9.0.1'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/private/tmp/tcl-tk-20241221-6502-car2ia/tcl9.0.1/unix -ltclstub'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/local/Cellar/tcl-tk/9.0.1/lib -ltclstub'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/private/tmp/tcl-tk-20241221-6502-car2ia/tcl9.0.1/unix/libtclstub.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/local/Cellar/tcl-tk/9.0.1/lib/libtclstub.a'
