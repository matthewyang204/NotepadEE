...
# installed.
TK_PREFIX='/usr/local/Cellar/tcl-tk/9.0.1'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/usr/local/Cellar/tcl-tk/9.0.1'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/private/tmp/tcl-tk--tk-20241221-6502-geb4u9/tk9.0.1/unix -ltcl9tk9.0'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/local/Cellar/tcl-tk/9.0.1/lib -ltcl9tk9.0'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/usr/local/Cellar/tcl-tk/9.0.1/include/tcl-tk'
...
# compiled.
TK_SRC_DIR='/private/tmp/tcl-tk--tk-20241221-6502-geb4u9/tk9.0.1'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/private/tmp/tcl-tk--tk-20241221-6502-geb4u9/tk9.0.1/unix -ltkstub'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/local/Cellar/tcl-tk/9.0.1/lib -ltkstub'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/private/tmp/tcl-tk--tk-20241221-6502-geb4u9/tk9.0.1/unix/libtkstub.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/local/Cellar/tcl-tk/9.0.1/lib/libtkstub.a'

# Top-level directory in which Tk's demo files are installed.
TK_DEMO_DIR='/usr/local/Cellar/tcl-tk/9.0.1/lib/tk9.0/demos'
