...
sudo rm -R ~/Downloads/Notepad==.app ~/Downloads/NotepadEE-macOS-arm64.zip

echo "Setup is downloading files..."
cd ~/Downloads
wget https://github.com/matthewyang204/NotepadEE/releases/download/3.1.0/NotepadEE-macOS-arm64.zip

echo "Setup is unpacking files..."
unzip NotepadEE-macOS-arm64.zip
...
sudo rm -R NotepadEE-macOS-arm64.zip
